...
W = tf.get_variable(name = 'W', shape = [1], dtype = tf.float32, initializer= tf.truncated_normal_initializer())
b = tf.get_variable(name = 'b', shape = [1], dtype = tf.float32, initializer= tf.constant_initializer(0.0))
...
plt.savefig('./image/LAB01-2_linear_regression_get_variable.jpg')
plt.show()
